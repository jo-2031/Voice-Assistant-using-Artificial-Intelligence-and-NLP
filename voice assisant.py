...
def respond(voice_data):
    ...
    if there_exists(["amazon product "]):
        search_term = voice_data.split("for")[-1]
    ...
    if there_exists(['who are you','what can you do']):
            engine_speak('I am Joe 1 point O your persoanl assistant. I am programmed to minor tasks like'
